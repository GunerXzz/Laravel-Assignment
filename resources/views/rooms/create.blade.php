<x-app-layout>
    <x-slot name="header">Add Room</x-slot>
        ...
        <form method="POST" action="{{ route('rooms.store') }}">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control" name="room_number" value="{{ old('room_number') }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control" type="number" name="floor" value="{{ old('floor') }}">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="status" required>
                        ...
                        <option value="occupied" @selected(old('status','occupied')==='occupied')>Occupied</option>
